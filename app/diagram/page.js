  ...
  async function analyzeStyle() {
    ...
    try {
      ...
      formData.append(
       formData.append(
  "request",
  `1枚目は現在の人物写真、2枚目は目標ヘアスタイルの参考写真です。

1枚目の人物の顔、顔立ち、肌、表情、頭の向き、服装、背景は維持してください。

ただし髪型は1枚目を維持しないでください。
髪型は明確に変更してください。

2枚目からヘアスタイルだけを読み取り、
前髪、顔まわり、全体の長さ、アウトライン、レイヤー構成、ウエイト位置、毛先の形、ボリューム、シルエットを参考にして、
1枚目の人物が実際にそのヘアスタイルへカットした後のリアルな完成写真を生成してください。

2枚目の人物の顔はコピーしないでください。
1枚目の人物の髪色は可能な限り維持してください。

最重要条件：
現在の髪型をそのまま出力するのは禁止です。
2枚目のヘアスタイルへの明確な変化が画像上で確認できるようにしてください。`
);
